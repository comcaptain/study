...
Redux store provides a `replaceReducer(newRootReducer)` to replace reducer. And we can create reducer manager like below to dynamically add/remove splitted reducer:
